...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ Tswitch ab[breviate] addo[ns] ao au[tocmd] ba[ck] background bg bd[elete]
    \ blistk[eys] blk bm[ap] bma[rk] bmarks bno[remap] b[uffer] buffers files ls
    \ tabs buf[tabs] bt bugepo bugmfs bugs builds bunm[ap] bz ca[bbreviate]
    \ caretlistk[eys] caretlk caretm[ap] caretno[remap] caretunm[ap] cd chd[ir]
    \ clistk[eys] clk cm[ap] cno[remap] colo[rscheme] com[mand] comp[letions]
    \ contexts cookies ck cuna[bbreviate] cunm[ap] delbm[arks] delc[ommand]
    \ delg[roup] delmac[ros] delm[arks] delqm[arks] dels[tyle] deluseragent
    \ delua dia[log] dlc[lear] doautoa[ll] do[autocmd] downl[oads] dl ec[ho]
    \ echoe[rr] echom[sg] el[se] elsei[f] elif em[enu] en[dif] fi exe[cute] exit
    \ x exta[dd] extde[lete] extrm extd[isable] exte[nable] exto[ptions]
    \ extp[references] extr[ehash] extt[oggle] extu[pdate] feedkeys fk fini[sh]
    \ fisheye fo[rward] fw frameo[nly] gmail ha[rdcopy] h[elp] helpa[ll]
    \ hi[ghlight] hist[ory] hs ia[bbreviate] if ilistk[eys] ilk im[ap]
    ...
    \ mbo mes[sages] messc[lear] mkp[entadactylrc] mkv[imruntime] mlistk[eys]
    \ mlk mm[ap] mno[remap] munm[ap] nlistk[eys] nlk nm[ap] nno[remap]
    \ noh[lfind] no[remap] norm[al] nunm[ap] olistk[eys] olk om[ap] ono[remap]
    \ o[pen] ounm[ap] pa[geinfo] pagest[yle] pas pin[tab] pref[erences] prefs
    \ pw[d] qma[rk] qmarks q[uit] quita[ll] qa[ll] r2 read redr[aw] reg[isters]
    \ reh[ash] re[load] reloada[ll] res[tart] rin[board] runt[ime] sa[nitize]
    \ sav[eas] w[rite] sbcl[ose] scrip[tnames] sdk se[t] setg[lobal] setl[ocal]
    \ sideb[ar] sb[ar] sbop[en] sil[ent] so[urce] statusboard st[op] stopa[ll]
    \ sty[le] styled[isable] styd[isable] stylee[nable] stye[nable]
    \ stylet[oggle] styt[oggle] support tab taba[ttach] tabc[lose] tabde[tach]
    \ tabd[o] bufd[o] tabdu[plicate] tabl[ast] bl[ast] tabm[ove] tabn[ext]
    \ tn[ext] bn[ext] tabo[nly] tabopen t[open] tabnew tabp[revious] tp[revious]
    \ tabN[ext] tN[ext] bp[revious] bN[ext] tabr[ewind] tabfir[st] br[ewind]
    \ bf[irst] teamcity tiki time tlistk[eys] tlk tm[ap] tno[remap]
    \ toolbarh[ide] tbh[ide] toolbars[how] tbs[how] toolbart[oggle] tbt[oggle]
    \ tunm[ap] una[bbreviate] u[ndo] undoa[ll] unl[et] unm[ap] unpin[tab]
    \ update-pentadactyl-nightly useragent ua verb[ose] ve[rsion] vie[wsource]
    \ vlistk[eys] vlk vm[ap] vno[remap] vunm[ap] w08 winc[lose] wc[lose]
...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    \ buftabs-elem bte cdpath cd complete cpt cookieaccept ca cookielifetime cl
    \ cookies ck defsearch ds downloadsort dlsort dls editor encoding enc
    \ eventignore ei extendedhinttags eht fileencoding fenc findcase fc
    \ findflags ff followhints fh guioptions go helpfile hf hintinputs hin
    \ hintkeys hk hintmatching hm hinttags ht hinttimeout hto history hi
    \ iskeyword isk jumptags jt linenumbers ln loadplugins lpl maxitems messages
...
let s:toggleOptions = ["banghist", "bh", "buftabs", "bt", "buftabs-progress",
    \ "btp", "buftabs-rnu", "btr", "errorbells", "eb", "exrc", "ex",
